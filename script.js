...
async function sendMessage() {
    ...
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
        ...
        headers: {
            ...
            "Authorization": "Bearer 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"
        },
        body: JSON.stringify({
            model: "gpt-3.5-turbo",
            messages: [
